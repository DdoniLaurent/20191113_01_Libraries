...
//        Toast.makeText(mContext, "테스트용 토스트", Toast.LENGTH_SHORT).show()
        ...
        callBtn.setOnClickListener {
            ...
            var permissionListener = object : PermissionListener{
                override fun onPermissionGranted() {
                    var uri = Uri.parse("tel: ${phoneTxt.text.toString().replace("-", "")}")
    ...
    override fun setValues() {
        var url = "http://image.kyobobook.co.kr/newimages/giftshop_new/goods/400/1539/S1458632370750.jpg"
